import os
import linecache
import  dbprocesstopic_extend
f = open("E:\wikidata\use-extract\BTM-master\output-extend\\voca.txt")
dictvoca = {}
...
# print  dictvoca
f.close()
f1 = open("E:\wikidata\use-extract\BTM-master\output-extend\model\k200.pz_d")
f2 = "E:\wikidata\use-extract\BTM-master\output\model\k200.pw_z"
cntid = 0
for line in f1.readlines():
    cntid += 1
    print  cntid
    msg = linecache.getline("E:\wikidata\use-extract\BTM-master\sample-data\doc_info.txt", cntid)
    print  msg
    dicttopic = {}
    cnt = 0
    line = line[:-2]
    ...
    dbprocesstopic_extend.Fun_DB(cntid,msg,res)